...
num_active_qtrs = st.number_input("Number of Active Quarters last year", min_value=0, max_value=4, value=2)
...
subscription_time_2022 = st.number_input("Subscription Time in last year (Days)", min_value=1, max_value=364, value=180)
subscription_time_2023 = st.number_input("Subscription Time in this year (Days)", min_value=1, max_value=364, value=180)
